class Admin::HeadlinesController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @headline.save
        format.html { redirect_to [:admin, @headline], notice: 'Headline was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @headline.update_attributes(params[:headline])
        format.html { redirect_to [:admin, @headline], notice: 'Headline was successfully updated.' }
